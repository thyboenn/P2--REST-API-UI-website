...
import { getApiData, bodyFileUpdate, urlCreator, loadIntoTable, sortGrid, executeGrid, readTextFile } from "./request.mjs";
...
class SpotifyEndpointObject {
    ...
    idCounterFunction() {
        ...
        if (this.id2 != "") { idCounter++ }
        if (this.id3 != "") { idCounter++ }
        // console.log(`this.id:`, this.id, `this.id2:`, this.id2);
        return idCounter;
    }
}
...
window.onload = function () {
    // console.log("readTextFile: ", readTextFile(0));
    ...
    /*Laver Key og Token, men det virker ikke endnu*/
    // let keyTokenElement = document.getElementById("webhooks");
    // keyTokenElement.addEventListener(`click`, function () {
    //     let trelloToken = document.getElementById("Token").value;
    //     let trelloKey = document.getElementById("key").value;
    //     console.log("Key and Token:", trelloKey, trelloToken);
    // })
    ...
    console.log(mainCategories[0].length);
    for (let j = 0; j < 2; j++) {
    ...
    BtnSubmit.addEventListener('click', function () {
        console.log("returnHolder[3]", returnHolder[3]);
        console.log("returnHolder[4]", returnHolder[4]);
        console.log("returnHolder[5]", returnHolder[5]);
        gridExecution[gridExecutionIndex] = choosingBox(returnHolder[3], returnHolder[4], returnHolder[5]);
        console.log("GridExecution: ", gridExecution);
        gridExecutionIndex++;
    });
    ...
    gridSubmit.addEventListener('click', function () {
        ...
        console.log("GRIDEXECUTIONSORTED: ", gridExecutionSorted);
        executeGrid(gridExecutionSorted, amountOfRows);
    });
    }
